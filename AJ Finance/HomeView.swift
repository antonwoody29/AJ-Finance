...
struct HomeView: View {
    ...
    private let tapSpeeches = [
        ...
        "Can I help you or nah? 😂",
        "You booped me. Illegal. 🚔",
        "Damn okay hello to you too 😭",
        "You got tap money? 💰",
        "That was aggressive bestie 😳",
        "I knew you'd come back 😌",
        "Again? We doing this again? 😂",
        "The obsession is mutual honestly 💙",
        "Not you checking if I'm still cute 😏",
        "Spoiler alert: I am 😌",
        "Bestie please I'm trying to look professional 😭",
        "My union representative will hear about this.",
        "You interrupted my thoughts 😤",
        "I was thinking about snacks.",
        "Important snack thoughts too.",
        "Do it again. I dare you. 👀",
        "You got one more tap before I start charging.",
        "That's gonna cost you 5 emotional support coins 🪙",
        "AWWWW YOU MISSED ME 🥺",
        "Okay clingy 😭",
        "You touch grass less than you touch me 😂",
        "HELLO HUMAN 👋",
        "Welcome back to the chaos.",
        "Financial gremlin reporting for duty.",
        "The vibes have been updated.",
        "You rang? ☎️",
        "Customer service how may I help? 😂",
        "I have no answers but lots of opinions.",
        "You poke. I judge.",
        "I poke back emotionally.",
        "Not the surprise inspection 👀",
        "Am I being audited?",
        "Please don't check my browser history 😭",
        "I wasn't doing anything suspicious. Probably.",
        "The cuteness remains undefeated.",
        "Tap acknowledged.",
        "Boop received.",
        "Attention acquired.",
        "Mission accomplished.",
        "You found me!",
        "Achievement unlocked: Annoy the mascot.",
        "Congrats bestie 🎉",
        "That was kinda rude ngl.",
        "Yet somehow I respect it.",
        "Your dedication concerns me 😂",
        "You must be bored bored.",
        "Financially responsible? Or just tapping me?",
        "We should probably save money today.",
        "Just a thought.",
        "Not financial advice. 😌",
        "Actually it kinda is.",
        "I appreciate the affection fr 💙",
        "This is why we're friends.",
        "Certified bestie behavior.",
        "Certified menace behavior.",
        "One of the two.",
        "You have selected: Chaos.",
        "Loading cute response…",
        "Response loaded successfully.",
        "Error 404: Personal space not found.",
        "I FELT THAT IN MY SOUL 😭",
        "Okay okay okay I hear you.",
        "What if instead of tapping me…",
        "You logged a transaction? 👀",
        "Just an idea.",
        "No pressure.",
        "Okay a little pressure 😏",
        "My emotional support budget depends on you.",
        "That tap gave me confidence.",
        "And slight anxiety.",
        "Mostly confidence.",
        "I was just taking a break 😭",
        "Work-life balance is important.",
        "Even for tiny animals.",
        "Bestie stop 😭😂",
        "BESTIE CONTINUE 😭💙",
        "I don't know what I expected.",
        "But it wasn't that.",
        "Respectfully what are we doing?",
        "Unrespectfully what are we doing?",
        "You got jokes huh?",
        "You got time today huh?",
        "I support your nonsense.",
        "Emotionally.",
        "Not financially.",
        "Tap harder and I might evolve.",
        "Results not guaranteed.",
        "The council has acknowledged your tap.",
        "The council remains confused.",
        "You seem nice.",
